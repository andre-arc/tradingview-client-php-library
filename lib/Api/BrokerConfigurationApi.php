...
/**
 * BrokerConfigurationApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class BrokerConfigurationApi
{
     ...
     * @return OneOfConfigResponseErrorResponse
     */
    public function getConfiguration($locale)
    {
        list($response) = $this->getConfigurationWithHttpInfo($locale);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of OneOfConfigResponseErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getConfigurationWithHttpInfo($locale)
    {
        $request = $this->getConfigurationRequest($locale);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('OneOfConfigResponseErrorResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'OneOfConfigResponseErrorResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = 'OneOfConfigResponseErrorResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        'OneOfConfigResponseErrorResponse',
     ...
     */
    public function getConfigurationAsync($locale)
    {
        return $this->getConfigurationAsyncWithHttpInfo($locale)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getConfigurationAsyncWithHttpInfo($locale)
    {
        $returnType = 'OneOfConfigResponseErrorResponse';
        $request = $this->getConfigurationRequest($locale);
     ...
     */
    public function getConfigurationRequest($locale)
    {
        // verify the required parameter 'locale' is set
        if ($locale === null || (is_array($locale) && count($locale) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $locale when calling getConfiguration'
            );
        }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SymbolMapping
     */
    public function getMapping()
    {
        list($response) = $this->getMappingWithHttpInfo();
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SymbolMapping, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMappingWithHttpInfo()
    {
        $request = $this->getMappingRequest();
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\SymbolMapping' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\SymbolMapping', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\SymbolMapping';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\SymbolMapping',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMappingAsync()
    {
        return $this->getMappingAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMappingAsyncWithHttpInfo()
    {
        $returnType = '\OpenAPI\Client\Model\SymbolMapping';
        $request = $this->getMappingRequest();
