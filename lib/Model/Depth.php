 ...
 */
class Depth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Depth';
     ...
     * Sets asks
     *
     * @param array[] $asks Array of arrays with two numeric elements - price and volume. Must be sorted by `price` in ascending order.
     *
     * @return self
     */
     ...
     * Sets bids
     *
     * @param array[] $bids Array of arrays with two numeric elements - price and volume. Must be sorted by `price` in ascending order.
     *
     * @return self
     */
