...
/**
 * CustomFieldsValueItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomFieldsValueItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomFieldsValueItem';
     ...
     * Sets id
     *
     * @param string $id Column identifier as defined in [/config](#operation/getConfiguration) response.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value Localized column value
     *
     * @return self
     */
