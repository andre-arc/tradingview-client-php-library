...
/**
 * OrderDialogCustomFields Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderDialogCustomFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderDialogCustomFields';
    ...
    protected static $openAPITypes = [
        'combo_box' => '\OpenAPI\Client\Model\ComboBoxMetaInfo[]'
    ];
    ...
    {
        $this->container['combo_box'] = $data['combo_box'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['combo_box']) && (count($this->container['combo_box']) < 1)) {
            $invalidProperties[] = "invalid value for 'combo_box', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets combo_box
     *
     * @return \OpenAPI\Client\Model\ComboBoxMetaInfo[]|null
     */
    public function getComboBox()
    {
        return $this->container['combo_box'];
    }

    /**
     * Sets combo_box
     *
     * @param \OpenAPI\Client\Model\ComboBoxMetaInfo[]|null $combo_box combo_box
     *
     * @return self
     */
    public function setComboBox($combo_box)
    {


        if (!is_null($combo_box) && (count($combo_box) < 1)) {
            throw new \InvalidArgumentException('invalid length for $combo_box when calling OrderDialogCustomFields., number of items must be greater than or equal to 1.');
        }
        $this->container['combo_box'] = $combo_box;
