...
/**
 * StreamingTradeResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StreamingTradeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamingTradeResponse';
     ...
     * Sets f
     *
     * @param string|null $f Should always be `t`.
     *
     * @return self
     */
