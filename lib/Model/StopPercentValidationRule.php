...
/**
 * StopPercentValidationRule Class Doc Comment
 *
 * @category Class
 ...
 */
class StopPercentValidationRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StopPercentValidationRule';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'options' => '\OpenAPI\Client\Model\StopPercentValidationRuleOptions'
    ];
    ...
    const ID_STOP_PERCENT = 'stopPercent';
     ...
     * Gets options
     *
     * @return \OpenAPI\Client\Model\StopPercentValidationRuleOptions
     */
     ...
     * Sets options
     *
     * @param \OpenAPI\Client\Model\StopPercentValidationRuleOptions $options options
     *
     * @return self
     */
