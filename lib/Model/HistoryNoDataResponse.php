...
/**
 * HistoryNoDataResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HistoryNoDataResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoryNoDataResponse';
     ...
     * Sets s
     *
     * @param string $s Status will always be `no_data`.
     *
     * @return self
     */
