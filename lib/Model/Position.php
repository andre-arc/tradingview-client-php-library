...
class Position implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets avg_price
     *
     * @param float $avg_price Average price of position trades.
     *
     * @return self
     */
     ...
     * Sets unrealized_pl
     *
     * @param float|null $unrealized_pl Unrealized (open) profit/loss.
     *
     * @return self
     */
     ...
     * Sets custom_fields
     *
     * @param \OpenAPI\Client\Model\CustomFieldsValueItem[]|null $custom_fields Localized position custom fields values data. Custom fields are configured in the [/config](#operation/getConfiguration) endpoint response.
     *
     * @return self
     */
    public function setCustomFields($custom_fields)
    {
        ...
        if (!is_null($custom_fields) && (count($custom_fields) < 1)) {
            throw new \InvalidArgumentException('invalid length for $custom_fields when calling Position., number of items must be greater than or equal to 1.');
        }
