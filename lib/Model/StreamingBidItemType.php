...
/**
 * StreamingBidItemType Class Doc Comment
 *
 * @category Class
 * @description Bid
 * @package  OpenAPI\Client
 ...
 */
class StreamingBidItemType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamingBidItemType';
