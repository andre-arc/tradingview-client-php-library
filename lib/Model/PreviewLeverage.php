...
/**
 * PreviewLeverage Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PreviewLeverage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PreviewLeverage';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['infos']) && (count($this->container['infos']) < 1)) {
            $invalidProperties[] = "invalid value for 'infos', number of items must be greater than or equal to 1.";
        }
     ...
     * Sets infos
     *
     * @param string[]|null $infos An array of information messages if any.
     *
     * @return self
     */
    public function setInfos($infos)
    {
        ...
        if (!is_null($infos) && (count($infos) < 1)) {
            throw new \InvalidArgumentException('invalid length for $infos when calling PreviewLeverage., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets warnings
     *
     * @param string[]|null $warnings An array of warning messages if any.
     *
     * @return self
     */
    public function setWarnings($warnings)
    {
        ...
        if (!is_null($warnings) && (count($warnings) < 1)) {
            throw new \InvalidArgumentException('invalid length for $warnings when calling PreviewLeverage., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets errors
     *
     * @param string[]|null $errors An array of error messages if any.
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if (!is_null($errors) && (count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling PreviewLeverage., number of items must be greater than or equal to 1.');
        }
