...
/**
 * StreamingAskResponseDeprecated Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StreamingAskResponseDeprecated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamingAskResponse(deprecated)';
     ...
     * Sets f
     *
     * @param string|null $f Should always be `a`.
     *
     * @return self
     */
