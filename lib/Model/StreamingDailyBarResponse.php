...
/**
 * StreamingDailyBarResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StreamingDailyBarResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamingDailyBarResponse';
     ...
     * Sets f
     *
     * @param string|null $f Should always be `d`.
     *
     * @return self
     */
