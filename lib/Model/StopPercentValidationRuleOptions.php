...
/**
 * StopPercentValidationRuleOptions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StopPercentValidationRuleOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StopPercentValidationRule_options';
     ...
     * Sets min
     *
     * @param float $min Minimal value in percentage of the stop price relative to the current price.
     *
     * @return self
     */
     ...
     * Sets max
     *
     * @param float $max Maximum value in percentage of the stop price relative to the current price.
     *
     * @return self
     */
