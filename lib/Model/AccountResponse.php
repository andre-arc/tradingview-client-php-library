...
class AccountResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'd' => '\OpenAPI\Client\Model\Account[]'
    ];
     ...
     * Sets d
     *
     * @param \OpenAPI\Client\Model\Account[] $d d
     *
     * @return self
     */
    public function setD($d)
    {
        ...
        if ((count($d) < 1)) {
            throw new \InvalidArgumentException('invalid length for $d when calling AccountResponse., number of items must be greater than or equal to 1.');
        }
        $this->container['d'] = $d;
