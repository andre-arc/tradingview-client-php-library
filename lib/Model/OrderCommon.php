 ...
 */
class OrderCommon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderCommon';
    ...
    public function setCustomFields($custom_fields)
    {
        ...
        if (!is_null($custom_fields) && (count($custom_fields) < 1)) {
            throw new \InvalidArgumentException('invalid length for $custom_fields when calling OrderCommon., number of items must be greater than or equal to 1.');
        }
