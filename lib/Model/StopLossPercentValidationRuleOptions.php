...
/**
 * StopLossPercentValidationRuleOptions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StopLossPercentValidationRuleOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StopLossPercentValidationRule_options';
     ...
     * Sets min
     *
     * @param float $min Minimal value in percentage of the stop loss price relative to the parent order price.
     *
     * @return self
     */
     ...
     * Sets max
     *
     * @param float $max Maximum value in percentage of the stop loss price relative to the parent order price.
     *
     * @return self
     */
