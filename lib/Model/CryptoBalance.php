...
/**
 * CryptoBalance Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CryptoBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CryptoBalance';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['btc_value'] = $data['btc_value'] ?? null;
     ...
     * Sets long_name
     *
     * @param string|null $long_name Crypto currency name.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param float $total Total amount of the balance.
     *
     * @return self
     */
     ...
     * Sets available
     *
     * @param float $available The balance available to the user.
     *
     * @return self
     */
     ...
     * Sets reserved
     *
     * @param float|null $reserved Reserved balance amount that can't be used at the moment for any reasons.
     *
     * @return self
     */
     ...
     * Sets btc_value
     *
     * @param float|null $btc_value Total balance amount in BTC.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param float|null $value Balance amount in additional currency.
     *
     * @return self
     */
     ...
     * Sets value_currency
     *
     * @param string|null $value_currency Currency of the value. It can be either code, or symbol.
     *
     * @return self
     */
