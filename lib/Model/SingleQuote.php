 ...
 */
class SingleQuote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SingleQuote';
    ...
    protected static $attributeMap = [
        'ask' => 'ask',
        'bid' => 'bid',
        'buy_pip_value' => 'buyPipValue',
        'sell_pip_value' => 'sellPipValue',
        'hard_to_borrow' => 'hardToBorrow',
        'not_shortable' => 'notShortable',
        'halted' => 'halted'
    ];
    ...
    protected static $setters = [
        'ask' => 'setAsk',
        'bid' => 'setBid',
        'buy_pip_value' => 'setBuyPipValue',
        'sell_pip_value' => 'setSellPipValue',
        'hard_to_borrow' => 'setHardToBorrow',
        'not_shortable' => 'setNotShortable',
        'halted' => 'setHalted'
    ];
    ...
    protected static $getters = [
        'ask' => 'getAsk',
        'bid' => 'getBid',
        'buy_pip_value' => 'getBuyPipValue',
        'sell_pip_value' => 'getSellPipValue',
        'hard_to_borrow' => 'getHardToBorrow',
        'not_shortable' => 'getNotShortable',
        'halted' => 'getHalted'
    ];
    ...
    {
        $this->container['ask'] = $data['ask'] ?? null;
        $this->container['bid'] = $data['bid'] ?? null;
        $this->container['buy_pip_value'] = $data['buy_pip_value'] ?? null;
        $this->container['sell_pip_value'] = $data['sell_pip_value'] ?? null;
        $this->container['hard_to_borrow'] = $data['hard_to_borrow'] ?? false;
        $this->container['not_shortable'] = $data['not_shortable'] ?? false;
        $this->container['halted'] = $data['halted'] ?? false;
    }
     ...
     * @return float|null
     */
    public function getBuyPipValue()
    {
        return $this->container['buy_pip_value'];
    }

    /**
     * Sets buy_pip_value
     *
     * @param float|null $buy_pip_value Value of 1 pip in the account currency, used for calculating risks and trade value in the Order dialog for buy orders.
     *
     * @return self
     */
    public function setBuyPipValue($buy_pip_value)
    {
        $this->container['buy_pip_value'] = $buy_pip_value;
     ...
     * @return float|null
     */
    public function getSellPipValue()
    {
        return $this->container['sell_pip_value'];
    }

    /**
     * Sets sell_pip_value
     *
     * @param float|null $sell_pip_value Value of 1 pip in the account currency, used for calculating risks and trade value in the Order dialog for sell orders.
     *
     * @return self
     */
    public function setSellPipValue($sell_pip_value)
    {
        $this->container['sell_pip_value'] = $sell_pip_value;
     ...
     * @return bool|null
     */
    public function getHardToBorrow()
    {
        return $this->container['hard_to_borrow'];
    }

    /**
     * Sets hard_to_borrow
     *
     * @param bool|null $hard_to_borrow Specify if the instrument is hard to borrow.
     *
     * @return self
     */
    public function setHardToBorrow($hard_to_borrow)
    {
        $this->container['hard_to_borrow'] = $hard_to_borrow;
     ...
     * @return bool|null
     */
    public function getNotShortable()
    {
        return $this->container['not_shortable'];
    }

    /**
     * Sets not_shortable
     *
     * @param bool|null $not_shortable Specify if the instrument is not shortable.
     *
     * @return self
     */
    public function setNotShortable($not_shortable)
    {
        $this->container['not_shortable'] = $not_shortable;
    ...
    {
        return $this->container['halted'];
    }

    /**
     * Sets halted
     *
     * @param bool|null $halted Specify if the instrument is halted.
     *
     * @return self
     */
    public function setHalted($halted)
    {
        $this->container['halted'] = $halted;
