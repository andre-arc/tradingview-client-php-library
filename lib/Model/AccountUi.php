...
/**
 * AccountUi Class Doc Comment
 *
 * @category Class
 * @description Account manager and Order dialog configuration for the account. The Account manager configuration will override configuration, specified in the [/config](#operation/getConfiguration) endpoint.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AccountUi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Account_ui';
    ...
    protected static $openAPITypes = [
        'account_summary_row' => '\OpenAPI\Client\Model\AccountSummaryRowItem[]',
        'account_manager' => '\OpenAPI\Client\Model\AccountManagerTable[]',
        'order_custom_fields' => '\OpenAPI\Client\Model\AccountManagerColumn[]',
        'order_history_custom_fields' => '\OpenAPI\Client\Model\AccountManagerColumn[]',
        'position_custom_fields' => '\OpenAPI\Client\Model\AccountManagerColumn[]',
        'order_dialog_custom_fields' => '\OpenAPI\Client\Model\OrderDialogCustomFields'
    ];
    ...
    protected static $openAPIFormats = [
        'account_summary_row' => null,
        'account_manager' => null,
        'order_custom_fields' => null,
        'order_history_custom_fields' => null,
        'position_custom_fields' => null,
        'order_dialog_custom_fields' => null
    ];
    ...
    protected static $attributeMap = [
        'account_summary_row' => 'accountSummaryRow',
        'account_manager' => 'accountManager',
        'order_custom_fields' => 'orderCustomFields',
        'order_history_custom_fields' => 'orderHistoryCustomFields',
        'position_custom_fields' => 'positionCustomFields',
        'order_dialog_custom_fields' => 'orderDialogCustomFields'
    ];
    ...
    protected static $setters = [
        'account_summary_row' => 'setAccountSummaryRow',
        'account_manager' => 'setAccountManager',
        'order_custom_fields' => 'setOrderCustomFields',
        'order_history_custom_fields' => 'setOrderHistoryCustomFields',
        'position_custom_fields' => 'setPositionCustomFields',
        'order_dialog_custom_fields' => 'setOrderDialogCustomFields'
    ];
    ...
    protected static $getters = [
        'account_summary_row' => 'getAccountSummaryRow',
        'account_manager' => 'getAccountManager',
        'order_custom_fields' => 'getOrderCustomFields',
        'order_history_custom_fields' => 'getOrderHistoryCustomFields',
        'position_custom_fields' => 'getPositionCustomFields',
        'order_dialog_custom_fields' => 'getOrderDialogCustomFields'
    ];
    ...
    {
        $this->container['account_summary_row'] = $data['account_summary_row'] ?? null;
        $this->container['account_manager'] = $data['account_manager'] ?? null;
        $this->container['order_custom_fields'] = $data['order_custom_fields'] ?? null;
        $this->container['order_history_custom_fields'] = $data['order_history_custom_fields'] ?? null;
        $this->container['position_custom_fields'] = $data['position_custom_fields'] ?? null;
        $this->container['order_dialog_custom_fields'] = $data['order_dialog_custom_fields'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['account_summary_row']) && (count($this->container['account_summary_row']) < 1)) {
            $invalidProperties[] = "invalid value for 'account_summary_row', number of items must be greater than or equal to 1.";
        }

        if (!is_null($this->container['account_manager']) && (count($this->container['account_manager']) < 1)) {
            $invalidProperties[] = "invalid value for 'account_manager', number of items must be greater than or equal to 1.";
        }

        if (!is_null($this->container['order_custom_fields']) && (count($this->container['order_custom_fields']) < 1)) {
            $invalidProperties[] = "invalid value for 'order_custom_fields', number of items must be greater than or equal to 1.";
        }

        if (!is_null($this->container['order_history_custom_fields']) && (count($this->container['order_history_custom_fields']) < 1)) {
            $invalidProperties[] = "invalid value for 'order_history_custom_fields', number of items must be greater than or equal to 1.";
        }

        if (!is_null($this->container['position_custom_fields']) && (count($this->container['position_custom_fields']) < 1)) {
            $invalidProperties[] = "invalid value for 'position_custom_fields', number of items must be greater than or equal to 1.";
        }
    ...
    /**
     * Gets account_summary_row
     *
     * @return \OpenAPI\Client\Model\AccountSummaryRowItem[]|null
     */
    public function getAccountSummaryRow()
    {
        return $this->container['account_summary_row'];
    }

    /**
     * Sets account_summary_row
     *
     * @param \OpenAPI\Client\Model\AccountSummaryRowItem[]|null $account_summary_row Localized Account Summary Row configuration. Account Summary Row is a panel at the top of the bottom widget with the key account indicators. The `supportCustomAccountSummaryRow` flag should be enabled in the account config, see the [/accounts](#operation/getAccounts) endpoint. Data of the Account Summary Row is filled using the [/state](/rest-api-spec/#operation/getState) endpoint.
     *
     * @return self
     */
    public function setAccountSummaryRow($account_summary_row)
    {


        if (!is_null($account_summary_row) && (count($account_summary_row) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_summary_row when calling AccountUi., number of items must be greater than or equal to 1.');
        }
        $this->container['account_summary_row'] = $account_summary_row;
     ...
     *
     * @return \OpenAPI\Client\Model\AccountManagerTable[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AccountManagerTable[]|null $account_manager Localized Account manager's tables configuration. Account manager is a page in the bottom widget. This page can have multiple tables. Data of the tables is filled using the [/state](/rest-api-spec/#operation/getState) endpoint.
     *
     * @return self
     */
    public function setAccountManager($account_manager)
    {
        ...
        if (!is_null($account_manager) && (count($account_manager) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_manager when calling AccountUi., number of items must be greater than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\AccountManagerColumn[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AccountManagerColumn[]|null $order_custom_fields Additional order columns to be displayed in the orders table of the Account manager. The orders table has a default set of columns that can be extended using this configuration. The `supportOrderCustomFields` flag should be enabled in the [account configuration](https://www.tradingview.com/rest-api-spec/#operation/getAccounts). Data of the additional fields is filled from the [/orders](https://www.tradingview.com/rest-api-spec/#operation/getOrders) `customFields` value.
     *
     * @return self
     */
    public function setOrderCustomFields($order_custom_fields)
    {
        ...
        if (!is_null($order_custom_fields) && (count($order_custom_fields) < 1)) {
            throw new \InvalidArgumentException('invalid length for $order_custom_fields when calling AccountUi., number of items must be greater than or equal to 1.');
        }
    ...
    /**
     * Gets order_history_custom_fields
     *
     * @return \OpenAPI\Client\Model\AccountManagerColumn[]|null
     */
    public function getOrderHistoryCustomFields()
    {
        return $this->container['order_history_custom_fields'];
    }

    /**
     * Sets order_history_custom_fields
     *
     * @param \OpenAPI\Client\Model\AccountManagerColumn[]|null $order_history_custom_fields Additional history columns to be displayed in the history table of the Account manager. The history table has a default set of columns that can be extended using this configuration. The `supportOrderHistoryCustomFields` and `supportOrdersHistory` flags should be enabled in the [account configuration](https://www.tradingview.com/rest-api-spec/#operation/getAccounts). Data of the additional fields is filled from the [/ordersHistory](/rest-api-spec/#operation/getOrdersHistory) `customFields` value.
     *
     * @return self
     */
    public function setOrderHistoryCustomFields($order_history_custom_fields)
    {


        if (!is_null($order_history_custom_fields) && (count($order_history_custom_fields) < 1)) {
            throw new \InvalidArgumentException('invalid length for $order_history_custom_fields when calling AccountUi., number of items must be greater than or equal to 1.');
        }
        $this->container['order_history_custom_fields'] = $order_history_custom_fields;

        return $this;
    }

    /**
     * Gets position_custom_fields
     *
     * @return \OpenAPI\Client\Model\AccountManagerColumn[]|null
     */
    public function getPositionCustomFields()
    {
        return $this->container['position_custom_fields'];
    }

    /**
     * Sets position_custom_fields
     *
     * @param \OpenAPI\Client\Model\AccountManagerColumn[]|null $position_custom_fields Additional position columns to be displayed in the positions table of the Account manager. The positions table has a default set of columns that can be extended using this configuration. The `supportPositionCustomFields` flag should be enabled in the [account configuration](https://www.tradingview.com/rest-api-spec/#operation/getAccounts). Data of the additional fields is filled from the [/positions](https://www.tradingview.com/rest-api-spec/#operation/getPositions) `customFields` value.
     *
     * @return self
     */
    public function setPositionCustomFields($position_custom_fields)
    {


        if (!is_null($position_custom_fields) && (count($position_custom_fields) < 1)) {
            throw new \InvalidArgumentException('invalid length for $position_custom_fields when calling AccountUi., number of items must be greater than or equal to 1.');
        }
        $this->container['position_custom_fields'] = $position_custom_fields;

        return $this;
    }

    /**
     * Gets order_dialog_custom_fields
     *
     * @return \OpenAPI\Client\Model\OrderDialogCustomFields|null
     */
    public function getOrderDialogCustomFields()
    {
        return $this->container['order_dialog_custom_fields'];
    }

    /**
     * Sets order_dialog_custom_fields
     *
     * @param \OpenAPI\Client\Model\OrderDialogCustomFields|null $order_dialog_custom_fields order_dialog_custom_fields
     *
     * @return self
     */
    public function setOrderDialogCustomFields($order_dialog_custom_fields)
    {
        $this->container['order_dialog_custom_fields'] = $order_dialog_custom_fields;
