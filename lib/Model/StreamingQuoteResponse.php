...
/**
 * StreamingQuoteResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StreamingQuoteResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamingQuoteResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['bp'] = $data['bp'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ap'] === null) {
            $invalidProperties[] = "'ap' can't be null";
        }
        if ($this->container['as'] === null) {
            $invalidProperties[] = "'as' can't be null";
        }
        if ($this->container['bp'] === null) {
            $invalidProperties[] = "'bp' can't be null";
        }
        if ($this->container['bs'] === null) {
            $invalidProperties[] = "'bs' can't be null";
        }
     ...
     * Sets f
     *
     * @param string $f Should always be `q`.
     *
     * @return self
     */
