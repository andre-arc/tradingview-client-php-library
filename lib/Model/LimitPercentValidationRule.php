...
/**
 * LimitPercentValidationRule Class Doc Comment
 *
 * @category Class
 ...
 */
class LimitPercentValidationRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LimitPercentValidationRule';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'options' => '\OpenAPI\Client\Model\LimitPercentValidationRuleOptions'
    ];
    ...
    const ID_LIMIT_PERCENT = 'limitPercent';
     ...
     * Gets options
     *
     * @return \OpenAPI\Client\Model\LimitPercentValidationRuleOptions
     */
     ...
     * Sets options
     *
     * @param \OpenAPI\Client\Model\LimitPercentValidationRuleOptions $options options
     *
     * @return self
     */
