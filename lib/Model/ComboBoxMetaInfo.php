...
/**
 * ComboBoxMetaInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ComboBoxMetaInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ComboBoxMetaInfo';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'title' => 'string',
        'save_to_settings' => 'bool',
        'mutable' => 'bool',
        'force_user_enter_initial_value' => 'bool',
        'items' => '\OpenAPI\Client\Model\ComboBoxValue[]'
    ];
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'title' => null,
        'save_to_settings' => null,
        'mutable' => null,
        'force_user_enter_initial_value' => null,
        'items' => null
    ];
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'title' => 'title',
        'save_to_settings' => 'saveToSettings',
        'mutable' => 'mutable',
        'force_user_enter_initial_value' => 'forceUserEnterInitialValue',
        'items' => 'items'
    ];
    ...
    protected static $setters = [
        'id' => 'setId',
        'title' => 'setTitle',
        'save_to_settings' => 'setSaveToSettings',
        'mutable' => 'setMutable',
        'force_user_enter_initial_value' => 'setForceUserEnterInitialValue',
        'items' => 'setItems'
    ];
    ...
    protected static $getters = [
        'id' => 'getId',
        'title' => 'getTitle',
        'save_to_settings' => 'getSaveToSettings',
        'mutable' => 'getMutable',
        'force_user_enter_initial_value' => 'getForceUserEnterInitialValue',
        'items' => 'getItems'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['save_to_settings'] = $data['save_to_settings'] ?? false;
        $this->container['mutable'] = $data['mutable'] ?? true;
        $this->container['force_user_enter_initial_value'] = $data['force_user_enter_initial_value'] ?? false;
     ...
     * Sets title
     *
     * @param string $title Localized field display name.
     *
     * @return self
     */
    ...
    /**
     * Gets save_to_settings
     *
     * @return bool|null
     */
    public function getSaveToSettings()
    {
        return $this->container['save_to_settings'];
    }

    /**
     * Sets save_to_settings
     *
     * @param bool|null $save_to_settings Whether the value should be stored in the user settings and preserved for the next time the dialog is displayed.
     *
     * @return self
     */
    public function setSaveToSettings($save_to_settings)
    {
        $this->container['save_to_settings'] = $save_to_settings;
     ...
     * Sets mutable
     *
     * @param bool|null $mutable Whether the integration supports modifying of this field.
     *
     * @return self
     */
    ...
    /**
     * Gets force_user_enter_initial_value
     *
     * @return bool|null
     */
    public function getForceUserEnterInitialValue()
    {
        return $this->container['force_user_enter_initial_value'];
    }

    /**
     * Sets force_user_enter_initial_value
     *
     * @param bool|null $force_user_enter_initial_value If this flag is set to true, the user will not be able to place an order without explicitly entering a value, so instant order placement is not available.
     *
     * @return self
     */
    public function setForceUserEnterInitialValue($force_user_enter_initial_value)
    {
        $this->container['force_user_enter_initial_value'] = $force_user_enter_initial_value;
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\ComboBoxValue[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\ComboBoxValue[] $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling ComboBoxMetaInfo., number of items must be greater than or equal to 1.');
        }
