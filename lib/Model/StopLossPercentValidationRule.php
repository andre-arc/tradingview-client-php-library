...
/**
 * StopLossPercentValidationRule Class Doc Comment
 *
 * @category Class
 ...
 */
class StopLossPercentValidationRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StopLossPercentValidationRule';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'options' => '\OpenAPI\Client\Model\StopLossPercentValidationRuleOptions'
    ];
     ...
     * Gets options
     *
     * @return \OpenAPI\Client\Model\StopLossPercentValidationRuleOptions
     */
     ...
     * Sets options
     *
     * @param \OpenAPI\Client\Model\StopLossPercentValidationRuleOptions $options options
     *
     * @return self
     */
