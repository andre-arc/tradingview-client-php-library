...
/**
 * OrderPreviewSection Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderPreviewSection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderPreviewSection';
    ...
    protected static $openAPITypes = [
        'rows' => '\OpenAPI\Client\Model\OrderPreviewSectionRow[]',
        'header' => 'string'
    ];
     ...
     * Gets rows
     *
     * @return \OpenAPI\Client\Model\OrderPreviewSectionRow[]
     */
     ...
     * Sets rows
     *
     * @param \OpenAPI\Client\Model\OrderPreviewSectionRow[] $rows Array of order preview items. Each item is a row of the section table.
     *
     * @return self
     */
     ...
     * Sets header
     *
     * @param string|null $header Optional title of the section.
     *
     * @return self
     */
