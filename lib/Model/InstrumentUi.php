...
/**
 * InstrumentUi Class Doc Comment
 *
 * @category Class
 * @description Order dialog configuration for the symbol. It will override configuration, specified in the [/accounts](#operation/getAccounts) endpoint.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InstrumentUi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Instrument_ui';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['validation_rules']) && (count($this->container['validation_rules']) < 1)) {
            $invalidProperties[] = "invalid value for 'validation_rules', number of items must be greater than or equal to 1.";
        }
     ...
     *
     * @return AnyOfStopPercentValidationRuleLimitPercentValidationRuleStopLossPercentValidationRuleTakeProfitPercentValidationRule[]|null
     */
     ...
     *
     * @param AnyOfStopPercentValidationRuleLimitPercentValidationRuleStopLossPercentValidationRuleTakeProfitPercentValidationRule[]|null $validation_rules Rules applied to field validation in the Order dialog. Please note: `stopPercent` and `limitPercent` validation rules are not applied if the `supportStopOrdersInBothDirections` flag is set to true.
     *
     * @return self
     */
    public function setValidationRules($validation_rules)
    {
        ...
        if (!is_null($validation_rules) && (count($validation_rules) < 1)) {
            throw new \InvalidArgumentException('invalid length for $validation_rules when calling InstrumentUi., number of items must be greater than or equal to 1.');
        }
