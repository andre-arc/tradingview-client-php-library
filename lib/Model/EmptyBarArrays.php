...
/**
 * EmptyBarArrays Class Doc Comment
 *
 * @category Class
 ...
 */
class EmptyBarArrays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmptyBarArrays';
    ...
    public function setT($t)
    {
        ...
        if (!is_null($t) && (count($t) > 0)) {
            throw new \InvalidArgumentException('invalid value for $t when calling EmptyBarArrays., number of items must be less than or equal to 0.');
        }
        $this->container['t'] = $t;
    ...
    public function setO($o)
    {
        ...
        if (!is_null($o) && (count($o) > 0)) {
            throw new \InvalidArgumentException('invalid value for $o when calling EmptyBarArrays., number of items must be less than or equal to 0.');
        }
        $this->container['o'] = $o;
    ...
    public function setH($h)
    {
        ...
        if (!is_null($h) && (count($h) > 0)) {
            throw new \InvalidArgumentException('invalid value for $h when calling EmptyBarArrays., number of items must be less than or equal to 0.');
        }
        $this->container['h'] = $h;
    ...
    public function setL($l)
    {
        ...
        if (!is_null($l) && (count($l) > 0)) {
            throw new \InvalidArgumentException('invalid value for $l when calling EmptyBarArrays., number of items must be less than or equal to 0.');
        }
        $this->container['l'] = $l;
    ...
    public function setC($c)
    {
        ...
        if (!is_null($c) && (count($c) > 0)) {
            throw new \InvalidArgumentException('invalid value for $c when calling EmptyBarArrays., number of items must be less than or equal to 0.');
        }
        $this->container['c'] = $c;
    ...
    public function setV($v)
    {
        ...
        if (!is_null($v) && (count($v) > 0)) {
            throw new \InvalidArgumentException('invalid value for $v when calling EmptyBarArrays., number of items must be less than or equal to 0.');
        }
        $this->container['v'] = $v;
