...
/**
 * AccountState Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountState';
    ...
    protected static $openAPITypes = [
        ...
        'equity' => 'float',
        'am_data' => 'string[][][]',
        'account_summary_row_data' => 'string[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'equity' => 'equity',
        'am_data' => 'amData',
        'account_summary_row_data' => 'accountSummaryRowData'
    ];
    ...
    protected static $setters = [
        'balance' => 'setBalance',
        'unrealized_pl' => 'setUnrealizedPl',
        'equity' => 'setEquity',
        'am_data' => 'setAmData',
        'account_summary_row_data' => 'setAccountSummaryRowData'
    ];
    ...
    protected static $getters = [
        'balance' => 'getBalance',
        'unrealized_pl' => 'getUnrealizedPl',
        'equity' => 'getEquity',
        'am_data' => 'getAmData',
        'account_summary_row_data' => 'getAccountSummaryRowData'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['unrealized_pl'] = $data['unrealized_pl'] ?? null;
        $this->container['equity'] = $data['equity'] ?? null;
        $this->container['am_data'] = $data['am_data'] ?? null;
        $this->container['account_summary_row_data'] = $data['account_summary_row_data'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['unrealized_pl'] === null) {
            $invalidProperties[] = "'unrealized_pl' can't be null";
        }
        if (!is_null($this->container['am_data']) && (count($this->container['am_data']) < 1)) {
            $invalidProperties[] = "invalid value for 'am_data', number of items must be greater than or equal to 1.";
        }

        if (!is_null($this->container['account_summary_row_data']) && (count($this->container['account_summary_row_data']) < 1)) {
            $invalidProperties[] = "invalid value for 'account_summary_row_data', number of items must be greater than or equal to 1.";
        }
    ...
    {
        return $this->container['unrealized_pl'];
    }

    /**
     * Sets unrealized_pl
     *
     * @param float $unrealized_pl Unrealized profit/loss.
     *
     * @return self
     */
    public function setUnrealizedPl($unrealized_pl)
    {
        $this->container['unrealized_pl'] = $unrealized_pl;
     ...
     * Sets equity
     *
     * @param float|null $equity Equity. If this field is not specified, then it is calculated as balance + unrealizedPl.
     *
     * @return self
     */
    ...
    {
        return $this->container['am_data'];
    }

    /**
     * Sets am_data
     *
     * @param string[][][]|null $am_data Account manager data. Structure of Account manager is defined by the [/config](#operation/getConfiguration) endpoint. Each element of this array is a table.
     *
     * @return self
     */
    public function setAmData($am_data)
    {


        if (!is_null($am_data) && (count($am_data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $am_data when calling AccountState., number of items must be greater than or equal to 1.');
        }
        $this->container['am_data'] = $am_data;

        return $this;
    }

    /**
     * Gets account_summary_row_data
     *
     * @return string[]|null
     */
    public function getAccountSummaryRowData()
    {
        return $this->container['account_summary_row_data'];
    }

    /**
     * Sets account_summary_row_data
     *
     * @param string[]|null $account_summary_row_data Account Summary Row data. Structure of Account Summary Row is defined by the [/config](#operation/getConfiguration) endpoint.
     *
     * @return self
     */
    public function setAccountSummaryRowData($account_summary_row_data)
    {


        if (!is_null($account_summary_row_data) && (count($account_summary_row_data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_summary_row_data when calling AccountState., number of items must be greater than or equal to 1.');
        }
        $this->container['account_summary_row_data'] = $account_summary_row_data;
