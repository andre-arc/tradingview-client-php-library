...
/**
 * TakeProfitPercentValidationRule Class Doc Comment
 *
 * @category Class
 ...
 */
class TakeProfitPercentValidationRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TakeProfitPercentValidationRule';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'options' => '\OpenAPI\Client\Model\TakeProfitPercentValidationRuleOptions'
    ];
     ...
     * Gets options
     *
     * @return \OpenAPI\Client\Model\TakeProfitPercentValidationRuleOptions
     */
     ...
     * Sets options
     *
     * @param \OpenAPI\Client\Model\TakeProfitPercentValidationRuleOptions $options options
     *
     * @return self
     */
