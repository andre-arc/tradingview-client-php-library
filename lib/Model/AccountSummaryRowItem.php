...
/**
 * AccountSummaryRowItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountSummaryRowItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountSummaryRowItem';
     ...
     * Sets id
     *
     * @param string $id Unique Account Summary Row item identifier.
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string $title Localized Account Summary Row item title.
     *
     * @return self
     */
