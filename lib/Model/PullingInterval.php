...
/**
 * PullingInterval Class Doc Comment
 *
 * @category Class
 ...
 */
class PullingInterval implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PullingInterval';
    ...
    {
        $this->container['quotes'] = $data['quotes'] ?? 500;
        $this->container['orders'] = $data['orders'] ?? 500;
        $this->container['positions'] = $data['positions'] ?? 1000;
        $this->container['account_manager'] = $data['account_manager'] ?? 500;
        $this->container['balances'] = $data['balances'] ?? 1000;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['quotes']) && ($this->container['quotes'] > 1000)) {
            $invalidProperties[] = "invalid value for 'quotes', must be smaller than or equal to 1000.";
        }

        if (!is_null($this->container['orders']) && ($this->container['orders'] > 1000)) {
            $invalidProperties[] = "invalid value for 'orders', must be smaller than or equal to 1000.";
        }

        if (!is_null($this->container['positions']) && ($this->container['positions'] > 1500)) {
            $invalidProperties[] = "invalid value for 'positions', must be smaller than or equal to 1500.";
        }

        if (!is_null($this->container['account_manager']) && ($this->container['account_manager'] > 1500)) {
            $invalidProperties[] = "invalid value for 'account_manager', must be smaller than or equal to 1500.";
        }

        if (!is_null($this->container['balances']) && ($this->container['balances'] > 1500)) {
            $invalidProperties[] = "invalid value for 'balances', must be smaller than or equal to 1500.";
        }
     ...
     * Sets quotes
     *
     * @param float|null $quotes Time interval in milliseconds to request quote and level 2 depth updates.
     *
     * @return self
     */
    public function setQuotes($quotes)
    {
        ...
        if (!is_null($quotes) && ($quotes > 1000)) {
            throw new \InvalidArgumentException('invalid value for $quotes when calling PullingInterval., must be smaller than or equal to 1000.');
        }
     ...
     * Sets orders
     *
     * @param float|null $orders Time interval in milliseconds to request orders.
     *
     * @return self
     */
    public function setOrders($orders)
    {
        ...
        if (!is_null($orders) && ($orders > 1000)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling PullingInterval., must be smaller than or equal to 1000.');
        }
     ...
     * Sets positions
     *
     * @param float|null $positions Time interval in milliseconds to request positions.
     *
     * @return self
     */
    public function setPositions($positions)
    {
        ...
        if (!is_null($positions) && ($positions > 1500)) {
            throw new \InvalidArgumentException('invalid value for $positions when calling PullingInterval., must be smaller than or equal to 1500.');
        }
     ...
     *
     * @param float|null $account_manager Time interval in milliseconds to update Account manager tables.
     *
     * @return self
     */
    public function setAccountManager($account_manager)
    {
        ...
        if (!is_null($account_manager) && ($account_manager > 1500)) {
            throw new \InvalidArgumentException('invalid value for $account_manager when calling PullingInterval., must be smaller than or equal to 1500.');
        }
     ...
     * Sets balances
     *
     * @param float|null $balances Time interval in milliseconds to request balances.
     *
     * @return self
     */
    public function setBalances($balances)
    {
        ...
        if (!is_null($balances) && ($balances > 1500)) {
            throw new \InvalidArgumentException('invalid value for $balances when calling PullingInterval., must be smaller than or equal to 1500.');
        }
