<?php
/**
 * StreamingDailyBarResponseAllOf
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * StreamingDailyBarResponseAllOf Class Doc Comment
 *
 * @category Class
 ...
 */
class StreamingDailyBarResponseAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamingDailyBarResponse_allOf';
     ...
     * Sets t
     *
     * @param float $t Unix timestamp in seconds. Timestamp time should be always 00:00 at the start of the day.
     *
     * @return self
     */
