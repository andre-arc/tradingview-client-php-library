...
/**
 * SymbolInfoArrays Class Doc Comment
 *
 * @category Class
 ...
 */
class SymbolInfoArrays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SymbolInfoArrays';
    ...
    public function setSymbol($symbol)
    {
        ...
        if ((count($symbol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $symbol when calling SymbolInfoArrays., number of items must be greater than or equal to 1.');
        }
