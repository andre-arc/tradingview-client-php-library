...
/**
 * ComboBoxValue Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ComboBoxValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ComboBoxValue';
     ...
     * Sets text
     *
     * @param string $text Localized display name.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value Value that is sent back to the server if the item is selected.
     *
     * @return self
     */
