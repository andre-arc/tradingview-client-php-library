...
/**
 * OrderCommonDuration Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderCommonDuration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderCommon_duration';
     ...
     * Sets type
     *
     * @param string $type Duration ID. Internal ID that you set in [/config](#operation/getConfiguration) response.
     *
     * @return self
     */
     ...
     * Sets datetime
     *
     * @param float|null $datetime Unix timestamp (UTC).
     *
     * @return self
     */
