...
/**
 * StreamingTradeItemType Class Doc Comment
 *
 * @category Class
 * @description Trade
 * @package  OpenAPI\Client
 ...
 */
class StreamingTradeItemType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamingTradeItemType';
