...
/**
 * OrderPreviewSectionRow Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderPreviewSectionRow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderPreviewSectionRow';
     ...
     * Sets title
     *
     * @param string $title Description of the item.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value Formatted value of the item.
     *
     * @return self
     */
