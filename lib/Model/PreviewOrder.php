 ...
 */
class PreviewOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'confirm_id' => 'string',
        'sections' => '\OpenAPI\Client\Model\OrderPreviewSection[]',
        'warnings' => 'string[]',
        'errors' => 'string[]'
    ];
    ...
    {
        $this->container['confirm_id'] = $data['confirm_id'] ?? null;
     ...
     * Sets confirm_id
     *
     * @param string|null $confirm_id An optional identifier of an order. It is sent back to the server in the place order request.
     *
     * @return self
     */
     ...
     * Gets sections
     *
     * @return \OpenAPI\Client\Model\OrderPreviewSection[]
     */
     ...
     * Sets sections
     *
     * @param \OpenAPI\Client\Model\OrderPreviewSection[] $sections sections
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param string[]|null $warnings Optional array of text warnings.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param string[]|null $errors Optional array of text errors.
     *
     * @return self
     */
