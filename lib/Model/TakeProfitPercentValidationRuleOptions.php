...
/**
 * TakeProfitPercentValidationRuleOptions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TakeProfitPercentValidationRuleOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TakeProfitPercentValidationRule_options';
     ...
     * Sets min
     *
     * @param float $min Minimal value in percentage of the take profit price relative to the parent order price.
     *
     * @return self
     */
     ...
     * Sets max
     *
     * @param float $max Maximum value in percentage of the take profit price relative to the parent order price.
     *
     * @return self
     */
