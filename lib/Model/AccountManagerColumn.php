...
/**
 * AccountManagerColumn Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountManagerColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountManagerColumn';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['alignment'] = $data['alignment'] ?? 'left';
        $this->container['is_capitalize'] = $data['is_capitalize'] ?? true;
    }
     ...
     * Sets title
     *
     * @param string $title Localized title of a column.
     *
     * @return self
     */
     ...
     * Sets tooltip
     *
     * @param string|null $tooltip Tooltip that is shown on mouse hover.
     *
     * @return self
     */
     ...
     * Sets alignment
     *
     * @param string|null $alignment The cell value alignment. Default value is `left`
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getIsCapitalize()
    {
        return $this->container['is_capitalize'];
    }

    /**
     * Sets is_capitalize
     *
     * @param bool|null $is_capitalize The first character of each word in the sentence will be capitalized. The rest of the symbols appearance does not change.
     *
     * @return self
     */
    public function setIsCapitalize($is_capitalize)
    {
        $this->container['is_capitalize'] = $is_capitalize;
