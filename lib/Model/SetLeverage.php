 ...
 */
class SetLeverage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetLeverage';
     ...
     * Sets leverage
     *
     * @param float $leverage Leverage value confirmed by broker.
     *
     * @return self
     */
