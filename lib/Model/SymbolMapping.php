...
/**
 * SymbolMapping Class Doc Comment
 *
 * @category Class
 ...
 */
class SymbolMapping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SymbolMapping';
    ...
    protected static $openAPITypes = [
        'symbols' => '\OpenAPI\Client\Model\SingleMapping[]',
        'fields' => '\OpenAPI\Client\Model\SingleField[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fields']) && (count($this->container['fields']) > 1)) {
            $invalidProperties[] = "invalid value for 'fields', number of items must be less than or equal to 1.";
        }
     ...
     * Gets symbols
     *
     * @return \OpenAPI\Client\Model\SingleMapping[]|null
     */
     ...
     * Sets symbols
     *
     * @param \OpenAPI\Client\Model\SingleMapping[]|null $symbols symbols
     *
     * @return self
     */
     ...
     * Gets fields
     *
     * @return \OpenAPI\Client\Model\SingleField[]|null
     */
     ...
     * Sets fields
     *
     * @param \OpenAPI\Client\Model\SingleField[]|null $fields Array with the only one element `['brokerSymbol']`.
     *
     * @return self
     */
    public function setFields($fields)
    {
        ...
        if (!is_null($fields) && (count($fields) > 1)) {
            throw new \InvalidArgumentException('invalid value for $fields when calling SymbolMapping., number of items must be less than or equal to 1.');
        }
        if (!is_null($fields) && (count($fields) < 1)) {
            throw new \InvalidArgumentException('invalid length for $fields when calling SymbolMapping., number of items must be greater than or equal to 1.');
        }
