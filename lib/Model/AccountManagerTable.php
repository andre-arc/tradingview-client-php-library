...
/**
 * AccountManagerTable Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountManagerTable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountManagerTable';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'title' => 'string',
        'columns' => '\OpenAPI\Client\Model\AccountManagerColumn[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['columns']) < 1)) {
            $invalidProperties[] = "invalid value for 'columns', number of items must be greater than or equal to 1.";
        }
     ...
     * Sets title
     *
     * @param string|null $title Localized title of a table.
     *
     * @return self
     */
     ...
     * Gets columns
     *
     * @return \OpenAPI\Client\Model\AccountManagerColumn[]
     */
     ...
     * Sets columns
     *
     * @param \OpenAPI\Client\Model\AccountManagerColumn[] $columns columns
     *
     * @return self
     */
    public function setColumns($columns)
    {
        ...
        if ((count($columns) < 1)) {
            throw new \InvalidArgumentException('invalid length for $columns when calling AccountManagerTable., number of items must be greater than or equal to 1.');
        }
