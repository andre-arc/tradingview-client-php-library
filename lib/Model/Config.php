...
class Config implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'pulling_interval' => '\OpenAPI\Client\Model\PullingInterval'
    ];
    ...
    protected static $setters = [
        ...
        'pulling_interval' => 'setPullingInterval'
    ];
    ...
    protected static $getters = [
        ...
        'pulling_interval' => 'getPullingInterval'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['pulling_interval'] = $data['pulling_interval'] ?? null;
    }
    ...
    public function setAccountSummaryRow($account_summary_row)
    {
        ...
        if (!is_null($account_summary_row) && (count($account_summary_row) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_summary_row when calling Config., number of items must be greater than or equal to 1.');
        }
    ...
    public function setAccountManager($account_manager)
    {
        ...
        if (!is_null($account_manager) && (count($account_manager) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_manager when calling Config., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets durations
     *
     * @param \OpenAPI\Client\Model\Duration[]|null $durations Localized array of durations displayed in Order Ticket.
     *
     * @return self
     */
    public function setDurations($durations)
    {
        ...
        if (!is_null($durations) && (count($durations) < 1)) {
            throw new \InvalidArgumentException('invalid length for $durations when calling Config., number of items must be greater than or equal to 1.');
        }
    ...
    public function setOrderCustomFields($order_custom_fields)
    {
        ...
        if (!is_null($order_custom_fields) && (count($order_custom_fields) < 1)) {
            throw new \InvalidArgumentException('invalid length for $order_custom_fields when calling Config., number of items must be greater than or equal to 1.');
        }
    ...
    public function setOrderHistoryCustomFields($order_history_custom_fields)
    {
        ...
        if (!is_null($order_history_custom_fields) && (count($order_history_custom_fields) < 1)) {
            throw new \InvalidArgumentException('invalid length for $order_history_custom_fields when calling Config., number of items must be greater than or equal to 1.');
        }
    ...
    public function setPositionCustomFields($position_custom_fields)
    {
        ...
        if (!is_null($position_custom_fields) && (count($position_custom_fields) < 1)) {
            throw new \InvalidArgumentException('invalid length for $position_custom_fields when calling Config., number of items must be greater than or equal to 1.');
        }
    ...
    /**
     * Gets pulling_interval
     *
     * @return \OpenAPI\Client\Model\PullingInterval|null
     */
    public function getPullingInterval()
    {
        return $this->container['pulling_interval'];
    }

    /**
     * Sets pulling_interval
     *
     * @param \OpenAPI\Client\Model\PullingInterval|null $pulling_interval pulling_interval
     *
     * @return self
     */
    public function setPullingInterval($pulling_interval)
    {
        $this->container['pulling_interval'] = $pulling_interval;
