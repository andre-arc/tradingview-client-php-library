...
/**
 * PermissionGroups Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PermissionGroups implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PermissionGroups';
     ...
     * Sets groups
     *
     * @param string[] $groups Groups list. Each element of this array is a group identifier.
     *
     * @return self
     */
