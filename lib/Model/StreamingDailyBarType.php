...
/**
 * StreamingDailyBarType Class Doc Comment
 *
 * @category Class
 ...
 */
class StreamingDailyBarType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamingDailyBarType';
