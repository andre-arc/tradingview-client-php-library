...
/**
 * StreamingAskItemType Class Doc Comment
 *
 * @category Class
 * @description Ask
 * @package  OpenAPI\Client
 ...
 */
class StreamingAskItemType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamingAskItemType';
