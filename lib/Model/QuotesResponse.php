 ...
 */
class QuotesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QuotesResponse';
    ...
    protected static $openAPITypes = [
        's' => '\OpenAPI\Client\Model\OkStatus',
        'd' => '\OpenAPI\Client\Model\QuotesResponseD[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['d']) < 1)) {
            $invalidProperties[] = "invalid value for 'd', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets s
     *
     * @return \OpenAPI\Client\Model\OkStatus
     */
     ...
     * Sets s
     *
     * @param \OpenAPI\Client\Model\OkStatus $s s
     *
     * @return self
     */
     ...
     * Gets d
     *
     * @return \OpenAPI\Client\Model\QuotesResponseD[]
     */
     ...
     * Sets d
     *
     * @param \OpenAPI\Client\Model\QuotesResponseD[] $d d
     *
     * @return self
     */
    public function setD($d)
    {
        ...
        if ((count($d) < 1)) {
            throw new \InvalidArgumentException('invalid length for $d when calling QuotesResponse., number of items must be greater than or equal to 1.');
        }
        $this->container['d'] = $d;
