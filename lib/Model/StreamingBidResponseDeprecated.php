...
/**
 * StreamingBidResponseDeprecated Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StreamingBidResponseDeprecated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamingBidResponse(deprecated)';
     ...
     * Sets f
     *
     * @param string|null $f Should always be `b`.
     *
     * @return self
     */
