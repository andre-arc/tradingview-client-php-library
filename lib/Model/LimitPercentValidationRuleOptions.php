...
/**
 * LimitPercentValidationRuleOptions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LimitPercentValidationRuleOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LimitPercentValidationRule_options';
     ...
     * Sets min
     *
     * @param float $min Minimal value in percentage of the limit price relative to the current price.
     *
     * @return self
     */
     ...
     * Sets max
     *
     * @param float $max Maximum value in percentage of the limit price relative to the current price.
     *
     * @return self
     */
