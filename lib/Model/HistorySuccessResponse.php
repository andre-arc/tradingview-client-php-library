...
/**
 * HistorySuccessResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HistorySuccessResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistorySuccessResponse';
     ...
     * Sets t
     *
     * @param float[] $t Bar time, Unix timestamp (UTC). Daily bars should only have the date part, time should be 0.
     *
     * @return self
     */
