...
/**
 * StreamingAskBidTradeItem Class Doc Comment
 *
 * @category Class
 ...
 */
class StreamingAskBidTradeItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamingAskBidTradeItem';
