...
/**
 * QuotesResponseD Class Doc Comment
 *
 * @category Class
 ...
 */
class QuotesResponseD implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QuotesResponse_d';
    ...
    protected static $openAPITypes = [
        's' => '\OpenAPI\Client\Model\Status',
        'n' => 'string',
        'v' => '\OpenAPI\Client\Model\SingleQuote'
    ];
     ...
     * Sets s
     *
     * @param \OpenAPI\Client\Model\Status $s s
     *
     * @return self
     */
     ...
     * Sets n
     *
     * @param string $n Symbol name. Should be equal to the requested one.
     *
     * @return self
     */
     ...
     * Gets v
     *
     * @return \OpenAPI\Client\Model\SingleQuote
     */
     ...
     * Sets v
     *
     * @param \OpenAPI\Client\Model\SingleQuote $v v
     *
     * @return self
     */
