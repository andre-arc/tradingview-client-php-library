 ...
 */
class GetLeverage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetLeverage';
     ...
     * Sets title
     *
     * @param string $title Title for leverage adjustment popup.
     *
     * @return self
     */
     ...
     * Sets leverage
     *
     * @param float $leverage Current leverage value.
     *
     * @return self
     */
     ...
     * Sets min
     *
     * @param float $min Minimum leverage value.
     *
     * @return self
     */
     ...
     * Sets max
     *
     * @param float $max Maximum leverage value.
     *
     * @return self
     */
     ...
     * Sets step
     *
     * @param float $step Leverage value change step.
     *
     * @return self
     */
